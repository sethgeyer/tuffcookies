...
module TuffCookie
 class CorrectGuessTally 
     ...
     def add_to_tally(evaluation, current_correct_guess_tally)
       ...
       elsif evaluation == "Same" || evaluation == "Reverse" || evaluation == "No Guess" || evaluation == "Give 2" || evaluation == "Give Me 2" || evaluation == "Suck It Nerds"
     ...
     def update_pot(evaluation, flipped_card)
        if evaluation == "Correct" || evaluation == "Wrong" || evaluation == "Same"  || evaluation == "Reverse" || evaluation == 'No Guess'  || evaluation == 'Give 2'  || evaluation == 'Give Me 2' || evaluation == "Suck It Nerds"
          @pot << flipped_card
        end
