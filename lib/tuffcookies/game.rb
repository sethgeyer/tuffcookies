...
module TuffCookie
  class Game
    attr_accessor :total_cards, :array_of_players, :player0, :player1, :player2, :player3, :current_card, :tally, :mark, :flipped_card, :evaluation, :current_correct_guess_tally, :current_player, :numbered_cards
